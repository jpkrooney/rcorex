...
## Hierarchical corex
`rcorex` can also discovered hierarchical structure in data by using the labels output from an `rcorex` object as the input to the next layer in the hierarchy as follows:
