...
Additional hierarchical layers can be identified in larger datasets. Note that in the network graph, edge thickness is proportional to mutual information and node size represents mutual multivariate information among children.
