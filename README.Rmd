...
Total correlation explanation is method for discovering latent structure in high dimensional data. Total correlation explanation has been implemented in Python as CorEx and related modules (https://github.com/gregversteeg/CorEx). The initial aim of rcorex is to implement Total Correlation Explanation in the R statistical software, specifically to replicate the functionality of the Bio CorEx Python module ( https://github.com/gregversteeg/bio_corex ) which is designed to  be sutiable for biomedical datasets.
